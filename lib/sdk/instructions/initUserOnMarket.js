...
function initUserOnMarket(context, marketAddress) {
    var _this = this;
    return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
        var _a, exchange, _b, authorityAddress, _c, serumOpenOrders, bump;
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 2:
                    _b = __read.apply(void 0, [_d.sent(), 1]), authorityAddress = _b[0];
                ...
                case 3:
                    _c = __read.apply(void 0, [_d.sent(), 2]), serumOpenOrders = _c[0], bump = _c[1];
                    context.program.rpc.initUserOnMarket(bump, {
                        accounts: {
                            exchange: exchange,
...
exports.default = initUserOnMarket;
