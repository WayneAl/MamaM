...
function initializeAmm(context, marketAddress, length, time_granularity, range) {
    ...
    return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
        var _a, exchange, configString, _b, amm, bump, vault1, vault2, minimumRentBalances;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, initializeAccountsWithLayouts(context, minimumRentBalances, vault1, vault2, constants_1.BTC, constants_1.USDC, amm)];
                case 4:
                    _c.sent();
                    // Add your test here.
