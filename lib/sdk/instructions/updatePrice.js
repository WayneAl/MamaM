...
function updatePrice(context, amm) {
    var _this = this;
    return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
        var _a, exchange, ammAccount, marketAddress, serumMarket, _b, serumOpenOrders, _c, authorityAddress;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0: return [4 /*yield*/, anchor.web3.PublicKey.findProgramAddress([Buffer.from("MamaM")], context.program.programId)];
                case 1:
                    _a = __read.apply(void 0, [_d.sent(), 1]), exchange = _a[0];
                    return [4 /*yield*/, context.program.account.amm.fetch(amm)];
                case 2:
                    ammAccount = _d.sent();
                    marketAddress = ammAccount.marketAddress;
                ...
                case 5:
                    _c = __read.apply(void 0, [_d.sent(), 1]), authorityAddress = _c[0];
